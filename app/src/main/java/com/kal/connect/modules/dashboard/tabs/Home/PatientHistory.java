...
import com.kal.connect.modules.dashboard.tabs.Appointments.Tabs.Examination.DataModel.GetPatientPojo;
import com.kal.connect.modules.dashboard.tabs.Appointments.Tabs.Examination.DataModel.MasterElement;
import com.kal.connect.modules.dashboard.tabs.Appointments.Tabs.Examination.DataModel.PatientExaminationData;
import com.kal.connect.modules.dashboard.tabs.Appointments.Tabs.Examination.DataModel.SubElement;
import com.kal.connect.modules.dashboard.tabs.Appointments.Tabs.Examination.PatientGridViewAdapter;
...
public class PatientHistory extends CustomActivity {
    ...
    void proceed(){
        Intent intent = new Intent(PatientHistory.this, IssueDescriptor.class);
...
//        historyData.put("", )
        ...
        Utilities.pushAnimation(PatientHistory.this);
    }
    ...
    public void buildUI() {
        ...
        setHeaderView(R.id.headerView, PatientHistory.this, PatientHistory.this.getResources().getString(R.string.issue_descriptor_title));
                ...
                try{
                    ...
                    for (int k = 0; k < masterElements.size(); k++) {
                        if (k == 0) {
                            ...
                            mAdapter = new PatientGridViewAdapter(PatientHistory.this, subElement.getAyurvedaModules());
                            ...
                            GridLayoutManager gridLayoutManager = new GridLayoutManager(PatientHistory.this, 3);
