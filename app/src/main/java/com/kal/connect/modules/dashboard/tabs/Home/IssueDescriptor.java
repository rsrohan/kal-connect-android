...
public class IssueDescriptor extends CustomMapActivity implements View.OnClickListener, TimePickerDialog.OnTimeSetListener,
...
//            return false;
    ...
    void setupData(){
        ...
        startActivity(new Intent(IssueDescriptor.this, HospitalsList.class));
...
//        appointmentTime.setTextColor(getResources().getColor(R.color.colorAccent,null));
        appointmentTime.setTextColor(ContextCompat.getColor(IssueDescriptor.this, R.color.colorAccent));
        tecContainerLayout.setVisibility(View.VISIBLE);
        selectTime.setBackgroundColor(getResources().getColor(R.color.background_grey));
        consultNow.setBackgroundColor(getResources().getColor(R.color.white));
