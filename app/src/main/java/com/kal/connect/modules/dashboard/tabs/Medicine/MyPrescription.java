...
public class MyPrescription extends CustomActivity {
    ...
    private void setAdapter() {
        mAdapter = new MyPrescriptionAdapter(mAlPrescription, MyPrescription.this);
    ...
    private void buildUI() {
        ...
        setHeaderView(R.id.headerView, MyPrescription.this, "Existing Prescription");
