...
public class PaymentWebVw extends CustomActivity implements View.OnClickListener{
    ...
    private void buildUI() {
        ...
        setHeaderView(R.id.headerView, PaymentWebVw.this, PaymentWebVw.this.getResources().getString(R.string.appointment_detail_title));
...
//                progDailog.dismiss();
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(PaymentWebVw.this);
...
//        final HashMap<String, Object> appointmentinputParams  = g.getAddAppointmentParams();
        ...
        SoapAPIManager apiManager = new SoapAPIManager(PaymentWebVw.this, appointmentinputParams, new APICallback() {
            @Override
                    ...
                    if(responseAry.length()>0){
                        ...
                        if(commonDataInfo.has("APIStatus") && Integer.parseInt(commonDataInfo.getString("APIStatus")) == -1){
                            if(commonDataInfo.has("APIStatus") && !commonDataInfo.getString("Message").isEmpty()){
                                Utilities.showAlert(PaymentWebVw.this,commonDataInfo.getString("Message"),false);
                            }else{
                                Utilities.showAlert(PaymentWebVw.this,"Please check again!",false);
                            }
                            return;
...
//                        loadAppointments(responseAry);
                        if(commonDataInfo.has("VCToekn") && !commonDataInfo.getString("VCToekn").isEmpty() &&
                            ...
                            Intent intent = new Intent(PaymentWebVw.this, VideoCaller.class);
                            ...
                            Utilities.pushAnimation(PaymentWebVw.this);

                        }

                    }
                }catch (Exception e){
                    Utilities.showAlert(PaymentWebVw.this,"Please contact support!",false);
        ...
        if (Utilities.isNetworkAvailable(PaymentWebVw.this)) {
            ...
            public void responseCallback(Context context, String response) throws JSONException {
                ...
                try{
                    ...
                    if(responseAry.length()>0){
                        ...
                        startActivity(new Intent(PaymentWebVw.this,Dashboard.class));
