...
public class MedicineAdapter extends RecyclerView.Adapter<MedicineAdapter.ViewHolder> {
    ...
    public MedicineAdapter(Medicine mMedicine, ArrayList<HashMap<String, Object>> partnerItems, Context context, ImageView mImgAddProduct, ImageView mImgOrder, ImageView mImgUplod, TextView mTxtAddProduct, TextView mTxtPlaceOrder, TextView mTxtUpload) {
    ...
    public void onBindViewHolder(MedicineAdapter.ViewHolder holder, int position) {
        ...
        mImgUplod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mIntent = new Intent(mContext, Prescription.class);
