...
public class DoctorsList extends CustomActivity {
    ...
    public void buildUI(){
        ...
        setHeaderView(R.id.headerView, DoctorsList.this, DoctorsList.this.getResources().getString(R.string.doctor_list));
...
//        createDoctorsList();
        ...
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(DoctorsList.this, LinearLayoutManager.VERTICAL, false);
...
//        inputParams.put("isInstant",appointmentParms.get("isInstant").toString());
        ...
        SoapAPIManager apiManager = new SoapAPIManager(DoctorsList.this, inputParams, new APICallback() {
            @Override
                    ...
                    if(responseAry.length()>0){
                        ...
                        if(commonDataInfo.has("APIStatus") && Integer.parseInt(commonDataInfo.getString("APIStatus")) == -1){
                            if(commonDataInfo.has("APIStatus") && !commonDataInfo.getString("Message").isEmpty()){
                                Utilities.showAlert(DoctorsList.this,commonDataInfo.getString("Message"),false);
                            }else{
                                Utilities.showAlert(DoctorsList.this,"Please check again!",false);
                            }
                            return;
...
//                        createDoctorsList(responseAry);
        ...
        if (Utilities.isNetworkAvailable(DoctorsList.this)) {
